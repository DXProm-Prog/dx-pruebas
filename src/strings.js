...
const STRINGS = {
  ...
  en: {
    // Participatory dues
    "cuotas.count": "How many types of dues or fees should there be? (everyone pays the same, or different groups of people pay differently)",
    "cuotas.memberSetup.single": "How many members will pay the dues or fees? (optional, just to see how much gets collected. The admin can skip this step)",
    "cuotas.names": "Propose names for the {count} dues or fees categories needed (one per box).",
    ...
    "cuotas.singleQuota": "How much should the dues or fees be?",
    ...
    "approval.label.cuotas": "the dues or fees",
